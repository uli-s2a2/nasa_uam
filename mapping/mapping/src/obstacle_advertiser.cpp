#include <mapping/obstacle_advertiser.hpp>
...
ObstacleAdvertiser::ObstacleAdvertiser() : Node("static_obstacle_advertiser")
{
	...
	// ----------------------- Publishers --------------------------
	obstacle_array_pub_ =
			this->create_publisher<mapping_msgs::msg::ObstacleArray>("mapping/obstacles", 10);
...
int main(int argc, char *argv[])
{
	...
	rclcpp::spin(std::make_shared<mapping::ObstacleAdvertiser>());
	rclcpp::shutdown();
	return 0;
}