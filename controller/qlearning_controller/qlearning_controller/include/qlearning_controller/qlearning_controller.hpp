...
#include <navigator_msgs/msg/path.hpp>
#include <Eigen/Dense>
#include <eigen3/unsupported/Eigen/KroneckerProduct>
#include <unsupported/Eigen/EulerAngles>
#include <controller_msgs/msg/attitude_setpoint.hpp>
#include <qlearning_controller_msgs/msg/q_learning_status.hpp>
...
private:
	// ----------------------- Publishers --------------------------
	rclcpp::Publisher<controller_msgs::msg::AttitudeSetpoint>::SharedPtr vehicle_attitude_setpoint_pub_;
	rclcpp::Publisher<qlearning_controller_msgs::msg::QLearningStatus>::SharedPtr qlearning_status_pub_;
