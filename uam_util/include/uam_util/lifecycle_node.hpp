...
#ifndef UAM_UTIL__LIFECYCLE_NODE_HPP_
#define UAM_UTIL__LIFECYCLE_NODE_HPP_

#include <memory>
#include <string>
#include <thread>

#include "uam_util/node_thread.hpp"
...
public:
	 ...
	 */
	std::shared_ptr<uam_util::LifecycleNode> shared_from_this()
	{
		return std::static_pointer_cast<uam_util::LifecycleNode>(
	 ...
	 */
	uam_util::CallbackReturn on_error(const rclcpp_lifecycle::State & /*state*/)
	{
		RCLCPP_FATAL(
				get_logger(),
...
#endif  // UAM_UTIL__LIFECYCLE_NODE_HPP_