...
#ifndef UAM_UTIL__SIMPLE_ACTION_SERVER_HPP_
#define UAM_UTIL__SIMPLE_ACTION_SERVER_HPP_
...
/**
 * @class uam_util::SimpleActionServer
...
public:
			  ...
			  spin_thread_(spin_thread)
	{
		...
		if (spin_thread_) {
			...
			executor_thread_ = std::make_unique<uam_util::NodeThread>(executor_);
		}
	}
...
protected:
	...
	std::unique_ptr<uam_util::NodeThread> executor_thread_;
...
#endif   // UAM_UTIL__SIMPLE_ACTION_SERVER_HPP_