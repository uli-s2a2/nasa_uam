...
#include "util/lifecycle_node.hpp"
namespace planner
{
...
protected:
	using ActionToPose = planner_msgs::action::ComputePathToPose;
	using ActionToPoseGoal = ActionToPose::Goal;
	using ActionServerToPose = util::SimpleActionServer<ActionToPose>;
	...
	pluginlib::ClassLoader<planner::PlannerBase> planner_loader_;
