#include "px4_bridge_rviz2_gui/px4_bridge_rviz2_gui.hpp"
...
namespace px4_bridge_rviz2_gui
{

VehicleInterfacePanel::VehicleInterfacePanel(QWidget * parent) : Panel(parent)
{
	std::string directory = ament_index_cpp::get_package_share_directory("rviz2_gui").append("/resource/gui.ui");
...
void VehicleInterfacePanel::updateNavigatorStatus(const navigator_msgs::msg::NavigatorStatus::UniquePtr msg)
{
...
void VehicleInterfacePanel::updateVehicleInterfaceStatus(const px4_bridge_msgs::msg::VehicleInterfaceStatus::UniquePtr msg)
{
...
{
	px4_bridge_msgs::msg::VehicleInterfaceCommand kill_switch_command_msg;
	if (kill_switch_state_machine_.configuration().contains(kill_switch_active_)) {
		kill_switch_command_msg.command = px4_bridge_msgs::msg::VehicleInterfaceCommand::VEHICLE_KILL_SWITCH_DISABLE;
	} else if (kill_switch_state_machine_.configuration().contains(kill_switch_inactive_)) {
		kill_switch_command_msg.command = px4_bridge_msgs::msg::VehicleInterfaceCommand::VEHICLE_KILL_SWITCH_ENABLE;
	}
...
PLUGINLIB_EXPORT_CLASS(rviz2_gui::VehicleInterfacePanel, rviz_common::Panel)