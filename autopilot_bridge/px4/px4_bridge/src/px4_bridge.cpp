#include "px4_bridge/px4_bridge.hpp"
#include "util/qos_profiles.hpp"

namespace vehicle_interface
{

Px4Bridge::Px4Bridge()
		: rclcpp::Node("px4_bridge")
{
	setupParameters();
	// ----------------------- Publishers --------------------------
	vehicle_command_pub_ =
			this->create_publisher<px4_msgs::msg::VehicleCommand>(
					"/fmu/in/vehicle_command", util::px4_qos_pub);
	offboard_control_mode_pub_ =
			this->create_publisher<px4_msgs::msg::OffboardControlMode>(
					"/fmu/in/offboard_control_mode", util::px4_qos_pub);
	vehicle_rates_setpoint_pub_ =
			this->create_publisher<px4_msgs::msg::VehicleRatesSetpoint>(
					"/fmu/in/vehicle_rates_setpoint", util::px4_qos_pub);
	vehicle_attitude_setpoint_pub_ =
			this->create_publisher<px4_msgs::msg::VehicleAttitudeSetpoint>(
					"/fmu/in/vehicle_attitude_setpoint", util::px4_qos_pub);
	vehicle_local_position_setpoint_pub_ =
			this->create_publisher<px4_msgs::msg::VehicleLocalPositionSetpoint>(
					"/fmu/in/vehicle_local_position_setpoint", util::px4_qos_pub);
	vehicle_odometry_pub_ =
			this->create_publisher<nav_msgs::msg::Odometry>(
					"/vehicle_interface/odometry", 10);
	vehicle_interface_status_pub_ =
			this->create_publisher<vehicle_interface_msgs::msg::VehicleInterfaceStatus>(
					"/vehicle_interface/vehicle_interface_status", 10);
	...
	battery_status_sub_ =
			this->create_subscription<px4_msgs::msg::BatteryStatus>(
					"/fmu/out/battery_status", util::px4_qos_sub,
					[this](const px4_msgs::msg::BatteryStatus::UniquePtr msg)
					{
						battery_status_ = *msg;
					});
	attitude_setpoint_sub_ =
			this->create_subscription<controller_msgs::msg::AttitudeSetpoint>(
					"/control/attitude_setpoint",
					10,
					std::bind(&Px4Bridge::publishAttitudeSetpoint, this, std::placeholders::_1));
	vehicle_status_sub_ =
	...
	vehicle_odometry_sub_ =
			this->create_subscription<px4_msgs::msg::VehicleOdometry>(
					...
					util::px4_qos_sub,
					std::bind(&Px4Bridge::vehicleOdometryCallback, this, std::placeholders::_1));
	channels_sub_ =
	...
	vehicle_interface_command_sub_ =
			this->create_subscription<vehicle_interface_msgs::msg::VehicleInterfaceCommand>(
					"/vehicle_interface/vehicle_interface_commands",
					10,
					[this](const vehicle_interface_msgs::msg::VehicleInterfaceCommand::UniquePtr msg)
					{
						switch (msg->command) {
							case vehicle_interface_msgs::msg::VehicleInterfaceCommand::VEHICLE_KILL_SWITCH_ENABLE:
								kill_switch_enabled_ = true;
								break;
							case vehicle_interface_msgs::msg::VehicleInterfaceCommand::VEHICLE_KILL_SWITCH_DISABLE:
	...
	timer_ = this->create_wall_timer(
			...
			[this]()
			{
				vehicle_interface_msgs::msg::VehicleInterfaceStatus status_msg;
...
void Px4Bridge::setupParameters()
{
	try {
...
*/
void Px4Bridge::publishOffboardControlMode()
{
 ...
 */
void Px4Bridge::publishVehicleCommand(uint16_t command, float param1, float param2)
{
...
//void Px4Bridge::publish_rate_control(mavRateControl control) {
...
void Px4Bridge::publishAttitudeSetpoint(const controller_msgs::msg::AttitudeSetpoint& msg)
{
...
void Px4Bridge::vehicleOdometryCallback(px4_msgs::msg::VehicleOdometry::UniquePtr msg)
{
...
void Px4Bridge::setupStaticTransforms()
{
...
//void Px4Bridge::publish_local_position_setpoint(mavLocalPositionSetpoint control)
//{
...
double Px4Bridge::computeRelativeThrust(const double &collective_thrust) const
{
...
int main(int argc, char *argv[])
{
	...
	rclcpp::spin(std::make_shared<vehicle_interface::Px4Bridge>());
	rclcpp::shutdown();
	return 0;
}
